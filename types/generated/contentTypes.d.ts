...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gifts: Attribute.Relation<
      ...
      'api::gift.gift'
    >;
    user_logo: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    hex_bg_code: Attribute.String;
    hex_text_code: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiGiftGift extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gift_categories: Attribute.Relation<
      'api::gift.gift',
      'oneToMany',
...
export interface ApiGiftCategoryGiftCategory extends Schema.CollectionType {
...
export interface ApiThemeTheme extends Schema.CollectionType {
  ...
  attributes: {
    ...
    main_color_hex: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 7;
      }>;
    secondary_color_hex: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 7;
      }>;
    decorator: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
